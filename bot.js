...
client.on('message', message => {
  ...
  if (message.content === 'guirihelp' || message.content === 'Guirihelp') {
    message.channel.send('Esse é o Guiribot, o bot do Guiri. Você pode brincar comigo usando as palavras: Guiritaro19, Guirichess, Guiribanho, Guirikid, Guirisexy, Guirigirl e Guiriaçai.E pra saber o meu endereço é só falar o meu nome e a palavra casa');
  }
